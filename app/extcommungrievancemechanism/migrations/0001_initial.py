    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('claim_category', models.CharField(choices=[('Odor', 'Odor'), ('Noise', 'Noise'), ('Effluents', 'Effluents'), ('Company vehicles', 'Company vehicles'), ('Flow of migrant workers', 'Flow of migrant workers'), ('Security personnel', 'Security personnel'), ('Other', 'Other')], max_length=50)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='complaint_and_claim_records', to=settings.AUTH_USER_MODEL)),
                ('photos_and_documents_proving_closure', models.ManyToManyField(blank=True, to='extcommungrievancemechanism.PhotoDocumentProvingClosure')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='claim_non_compliance_control', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observation', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='claim_complain_control', to=settings.AUTH_USER_MODEL)),
            ],
            options={
